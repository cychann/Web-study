...
const popUpRrefresh = document.querySelector('.pop-up__refresh');
...
popUpRrefresh.addEventListener('click', () => {
    startGame();
    hidePopUp();
})
...
function addItem(className, count, imgPath) {
    const x1 = 0;
    const y1 = 0;
    const x2 = fieldRect.width - CARRIT_SIZE;
    const y2 = fieldRect.height - CARRIT_SIZE;
